...
| 轮次 | 改动 | 分类准确率 | 行动准确率 | 工具覆盖 | 失败数 |
|------|------|-----------|-----------|---------|--------|
| 1 | 初版 | 69.6% | 73.2% | 61.0% | 27 |
| 2 | +标注修正 | 96.4% | 82.1% | 70.0% | 22 |
| 3 | +风险检测+先查后写 | 98.2% | 87.5% | 97.5% | 8 |
| 4 | +防诈骗+物流细化 | 98.2% | 92.9% | 100.0% | 5 |
| 5 | +停滞检测 | 98.2% | 89.3% | 100.0% | 7 |
| **6** | **+数据对齐+规则归位** | **100.0%** | **100.0%** | **100.0%** | **0** |

最新评估结果详见 [eval/results.json](eval/results.json)。
